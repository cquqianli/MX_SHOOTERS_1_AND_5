...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
	...
	else if (hcan->Instance==CAN2)
	{
		switch(rx_header.StdId)
		{
			...
			case 0x201:
			{
				canrxtomotinfo(&wheelinfo[0],rx_data);
			}break;
			
			case 0x202:
			{
				canrxtomotinfo(&wheelinfo[1],rx_data);
			}break;
			case 0x203:
			{
				canrxtomotinfo(&wheelinfo[2],rx_data);
			}break;
			case 0x204:
			{
...
//			case 0x203:
//			{
//					magainfo.tempdata.temp_angle[1] = (rx_data[0]<<8)|(rx_data[1]);
//					magainfo.tempdata.temp_angle[1] =magainfo.tempdata.temp_angle[1]*360.0f/0x1fff-180.f;
//					gearmotor_angledecoder(&magainfo);
//					magainfo.curmotorinfo.speed = ((float)((rx_data[2]<<8)|(rx_data[3])))/magainfo.parameter.reductiongearratio;
//					motcurrentsensor(&magainfo);
//					magainfo.curmotorinfo.current[0] = (float)((rx_data[4]<<8)|(rx_data[5]));
//			}break;
//			#endif
//			
